...
var spService = (function ($) {
	...
	var restEntryConnector = '/rest/entrypoint/';
	var getResult;
	var putResult;
	var delResult;
	var postResult;
	...
	function _postEntryParams(resource, params) {
		$.ajax({
			type: 'POST',
			url: restEntryConnector + resource,
			data: params,
			contentType: 'application/json',
			dataType: 'json',
			async: false,
	...
	return {
		...
		postEntryParams: function (resource, params) {
			_postEntryParams(resource, params);
			return postResult;
		},
